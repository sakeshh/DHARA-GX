## Assessment Report of `data_quality_issues.json`
...
|---|---|---:|---:|---:|---:|---:|---:|
| `data_quality_issues.json` | Filesystem (abfss://04a585ce-f0ec-4a3a-9db2-e237711fd9e7@onelake.dfs.fabric.microsoft.com/abd8c72d-b5aa-4b58-83bd-fb97587de47e/Files/raw/data_quality_issues_json.json) | 10000 | 3 | 17 | 1 | 6 | 10 |
...
| 99 | `data_quality_issues.json` | `email` | high | Review with domain owners; document the expected rule; add validation at ingest or in the warehouse. | Fallback mode (LLM not configured). Validate before applying changes. |
