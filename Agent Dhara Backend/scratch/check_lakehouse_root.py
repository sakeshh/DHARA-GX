...
# Correct ADLS Gen2 path: filesystem is workspace_id, directory is the lakehouse_folder
url = f"https://onelake.dfs.fabric.microsoft.com/{workspace_id}?directory={lakehouse_folder}&recursive=false&resource=filesystem"
headers = {
    "Authorization": f"Bearer {token}"
}

print(f"Checking lakehouse root '{lakehouse_folder}'...")
